...
const Footer = () => {
  return (
    <footer 
      ...
      style={{
        background: "linear-gradient(180deg, rgba(15,9,5,0.95) 0%, rgba(25,15,8,0.98) 50%, rgba(20,12,7,0.99) 100%)",
    ...
    >
      ...
      <div className="absolute top-8 right-1/3 w-1 h-1 bg-yellow-300 rounded-full opacity-40 animate-pulse" style={{ animationDelay: '1s' }}></div>
      <div className="absolute bottom-20 left-1/6 w-1 h-1 bg-yellow-400 rounded-full opacity-20 animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex items-center space-x-3 mb-6 group">
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 8px 16px rgba(0,0,0,0.4), inset 0 0 20px rgba(212,175,55,0.2)"
                }}
              >
              ...
              <div>
                ...
                <span className="text-sm text-amber-300 opacity-80">Digital Library</span>
              </div>
            </div>
            
            <p className="text-amber-200 mb-6 leading-relaxed text-lg">
              Discover your next favorite book through honest reviews from readers like you. 
              Join our literary community today.
            </p>
          ...
          {/* Explore Section */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-yellow-200 flex items-center" style={{ fontFamily: '"Cutive Mono", monospace' }}>
            ...
            <ul className="space-y-3">
              {[
                ...
                { to: "/books?genre=fiction", label: "Fiction" },
                { to: "/books?genre=non-fiction", label: "Non-Fiction" },
                { to: "/books?genre=mystery", label: "Mystery" },
                { to: "/books?genre=sci-fi", label: "Sci-Fi" },
                { to: "/books?genre=romance", label: "Romance" }
              ].map((link, index) => (
                <li key={index}>
                  <Link 
                    to={link.to} 
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { to: "/profile/reading-list", label: "Reading List" }
              ].map((link, index) => (
                <li key={index}>
                  <Link 
                    to={link.to} 
        ...
        <div 
          ...
          style={{
            background: "linear-gradient(135deg, rgba(255,255,153,0.1) 0%, rgba(212,175,55,0.1) 100%)",
            border: "2px solid rgba(212,175,55,0.3)",
            boxShadow: "inset 0 0 20px rgba(255,255,153,0.05)"
          }}
        >
          <h3 className="text-2xl font-bold text-yellow-200 mb-4" style={{ fontFamily: '"Cutive Mono", monospace' }}>
            Stay Updated with New Books
          </h3>
          <p className="text-amber-300 mb-6 text-lg max-w-2xl mx-auto">
            Get weekly recommendations and be the first to know about new additions to our library.
          </p>
